...
-- Cursed Sock: troubleshooting demo (magic tag). Price must stay non-negative so cart and payment totals remain valid.
INSERT INTO sock VALUES ("bad00002-0000-0000-0000-000000000002", "Cursed", "Demo sock for troubleshooting listings. Price is corrected to a valid retail amount so combined cart totals no longer violate payment validation.", 5.00, 50, "/catalogue/images/holy_1.jpeg", "/catalogue/images/holy_2.jpeg");
